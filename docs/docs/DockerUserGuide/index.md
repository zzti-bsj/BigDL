...
* you should set the `NOTEBOOK_PORT` enviroment variable to specific port number. 
* you should set the `NOTEBOOK_TOKEN` environment variable to specific token string.
